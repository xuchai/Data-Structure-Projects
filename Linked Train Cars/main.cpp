...
//    int denominator = 0;
//    int numerator = 0;
//    AverageDistance_DiningCar(simple, denominator, numerator);
...
void StudentTests() {
  ...
  std::cout << "STUDENT TESTS" << std::endl;
    ...
    // Belows are test cases of different questions:
    
    // PART I
    std::cout << "Test for functions: average distance to dining car / closest engine to sleeper: " << std::endl;
    ...
    DeleteAllCars(simple);
    // PART II
    std::cout << "Test for Freight trains: " << std::endl;
    MTRand_int32 mtrand_fixed_seed(42);
    std::cout << "============================================================================" << std::endl;
    std::cout << "SHIP FREIGHT TEST" << std::endl;
    ShipFreightHelper(mtrand_fixed_seed,4,20,100,12);
    ShipFreightHelper(mtrand_fixed_seed,4,20,60,3);
    ShipFreightHelper(mtrand_fixed_seed,1,10,60,10);
    ShipFreightHelper(mtrand_fixed_seed,11,40,65,10);
    ...
    PushBack(t, TrainCar::MakeEngine());
    PushBack(t, TrainCar::MakeEngine());
    SeparateTestHelper(t, " #with 4 engines in the head and tail");
    ...
    PushBack(t, TrainCar::MakeDiningCar());
    PushBack(t, TrainCar::MakePassengerCar());
    SeparateTestHelper(t, "#with 5 engines in the front");
    ...
    PushBack(t, TrainCar::MakeDiningCar());
    PushBack(t, TrainCar::MakePassengerCar());
    SeparateTestHelper(t, "#with 5 engines in the middle");
    ...
    PushBack(t, TrainCar::MakeEngine());
    PushBack(t, TrainCar::MakeEngine());
    SeparateTestHelper(t, "#with 5 engines in th end");
    ...
    PushBack(t, TrainCar::MakeEngine());
    PushBack(t, TrainCar::MakeDiningCar());
    SeparateTestHelper(t, "#with insert Structure");
    ...
    SeparateTestHelper(t, "#with A lot of engines");
    ...
    PushBack(t, TrainCar::MakePassengerCar());
    PushBack(t, TrainCar::MakePassengerCar());
    SeparateTestHelper(t, "#with 3 engines");
